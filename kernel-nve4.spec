...
- Optimized for NVE4 Kepler hardware
...
# Apply kernel patch for GK104 video engine firmware
patch -p1 < patches/0001-gk104-add-built-in-video-firmware.patch

# Firmware headers are already in correct tree locations from Source1
